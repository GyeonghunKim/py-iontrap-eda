...
@dataclass
class TweakerRailParameters(BaseRailParameters):
    n_layers: int
...
class TweakerRail(BaseRail):
    def __init__(self, name: str, parameters: TweakerRailParameters):
        self.parameters: TweakerRailParameters
    ...
    def compile_electrodes(self):
        ...
        self.electrodes.append(
            Electrode(
                ...
                shapely.Polygon(
                    (
                        (self.dc_z_points[0] - self.parameters.rf_padding_left_width - self.parameters.rf_merge_length, self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width),
                        (self.dc_z_points[-1] + self.parameters.rf_padding_right_width, self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width),
                        (self.dc_z_points[-1] + self.parameters.rf_padding_right_width, self.parameters.inner_dc_width + self.parameters.rf_width),
                        (self.dc_z_points[0] - self.parameters.rf_padding_left_width - self.parameters.rf_merge_length, self.parameters.inner_dc_width + self.parameters.rf_width),
                    )
                ),
            )
        )
            ...
            for sign in [1, -1]:
                self.electrodes.append(
                    Electrode(
                        ...
                        shapely.Polygon(
                            (
                                (z_left, sign * (self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width + self.parameters.dc_length)),
                                (z_right, sign * (self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width + self.parameters.dc_length)),
                                (z_right, sign * (self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width)),
                                (z_left, sign * (self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width)),
                                (z_left, sign * (self.parameters.inner_dc_width + self.parameters.rf_width + self.parameters.tweaker_width + self.parameters.dc_length)),
                            )
                        ),
                    )
